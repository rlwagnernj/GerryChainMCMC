...
def InitializeGerryChain(shp = ''):
    '''Shp --> initial_partition, proposal, constraints
       Shp = string path to shp file for initial map state
       '''

    #######################################################################################################################################################################################################
    # MAKE THE INITIAL GRAPH OBJECT #
    #######################################################################################################################################################################################################
    ...
    return initial_partition, proposal, constraint
...
######################################################################################################################################################################################################
def CreatePartition():
    '''get partition from last iteration 
    '''
    pass
